...
def search():
	...
	Flavor	= request.args.get('Flavor1')
	print(Flavor)
	if not color:
		data = []
		output_message = ''
		...
		master_data = pd.read_pickle("/home/farquhar13/CS4300_Flask_template/app/data/master_data_lean.pkl")
		vin_tfidf = np.load('/home/farquhar13/CS4300_Flask_template/app/data/vin_tfidf.npy').item()
		word_to_index = np.load('/home/farquhar13/CS4300_Flask_template/app/data/word_to_index.npy').item()
