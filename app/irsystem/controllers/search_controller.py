...
def search():
	...
	## comment to update code
		wines = pd.read_csv("/home/farquhar13/CS4300_Flask_template/app/data/winemag-data-130k-v2.csv")
		wines_color = pd.read_csv("/home/farquhar13/CS4300_Flask_template/app/data/Wine_color.csv")
